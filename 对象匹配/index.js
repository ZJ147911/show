 ...
 * @Date         :2022-07-28 11:22:08
 * @Description  :
 * @FilePath     :\utilitiesappd:\Users\Gitee\项目展示\对象匹配\index.js
 * @LastEditors  :赵军
 * @LastEditTime :2022-07-28 13:37:09
 */
const { npsProvince, province_list } = require("./config")
console.log(npsProvince, province_list)
let a = []
npsProvince.forEach((item) => {
	item.name = province_list[item.text]
})

console.log(npsProvince)[
